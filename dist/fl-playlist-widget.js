  ...
  _createClass(TrackList, [{
    ...
    value: function setTracks(tracks) {
      ...
      tracks.forEach(function (track) {
        ...
        _this2.setTrackListeners(trackEl);
    ...
    value: function createTrackEl(track) {
      ...
      var buttonsBarClass = trackClass + '-btns';
    ...
    key: 'setTrackListeners',
    value: function setTrackListeners(trackEl) {
      var _this3 = this;
      ...
      trackEl.dragBtn.addEventListener('dragstart', function (e) {
        ...
        var allTracks = Array.from(_this3.html.container.children);
